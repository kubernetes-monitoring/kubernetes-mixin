{
  _config+:: {
    ...
    grafanaDashboardIDs: {
      ...
      'k8s-multicluster-rsrc-use.json': std.md5('k8s-multicluster-rsrc-use.json'),
      'k8s-cluster-rsrc-use.json': std.md5('k8s-cluster-rsrc-use.json'),
      'k8s-node-rsrc-use.json': std.md5('k8s-node-rsrc-use.json'),
      'nodes.json': std.md5('nodes.json'),
      'persistentvolumesusage.json': std.md5('persistentvolumesusage.json'),
      'pods.json': std.md5('pods.json'),
      'statefulset.json': std.md5('statefulset.json'),
